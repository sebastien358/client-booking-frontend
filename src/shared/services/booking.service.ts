...
export const axiosBookingSlots = async (categoryId: number, serviceId: number, staffId: number, date: string) => {
...
export const axiosCreateBooking = async (dataBooking: BookingFormInterface) => {
  try {
